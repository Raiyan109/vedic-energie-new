...
const Contact = () => {
    return (
        <div>
            <Header />
            <div className="grid max-w-screen-xl grid-cols-1 gap-8 px-8 py-56 mx-auto rounded-lg md:grid-cols-2 md:px-12 lg:px-16 xl:px-32 dark:bg-gray-800 dark:text-gray-100">
