            ...
            <section className='bg-blue mx-auto lg:p-32 text-white'>
             {
                productDetails.map(product=><div key={product._id}>
                    ...
                    <div className='lg:w-1/2 w-full lg:p-0 p-8'>
                     ...
                     <div className='my-6'>
                     <button
                className='px-3 py-2 uppercase text-sm bg-yellow text-black hover:text-blue md:text-sm font-semibold hover:bg-orange hover:transition-all m-2'>Add to cart</button>
