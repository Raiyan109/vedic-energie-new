...
import { CeilingFanWattRanges } from '../../constants';
...
`
const CeilingFanWattInput = ({ceilingFanSelectedWattage, isCeilingFanOn, handleWattageSelect}) => {
  return (
    <div>
        <Section>
                <select name="watt" id="watt"
                    value={ceilingFanSelectedWattage}
                    ...
                    {
                        CeilingFanWattRanges.map((range, idx) => (
...
export default CeilingFanWattInput