...
import { TvWattRanges } from '../../constants';
...
`
const TvWattInput = ({TvSelectedWattage, isTvOn, handleWattageSelect}) => {
  return (
    <div>
        <Section>
                <select name="watt" id="watt"
                    value={TvSelectedWattage}
                    disabled={!isTvOn}
