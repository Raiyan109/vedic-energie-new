...
import { IronWattRanges } from '../../constants';
...
`
const IronInput = ({IronSelectedWattage, isIronOn, handleWattageSelect}) => {
  return (
    <div>
        <Section>
                <select name="watt" id="watt"
                    value={IronSelectedWattage}
                    disabled={!isIronOn}
