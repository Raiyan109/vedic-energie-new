...
import { IronLoads } from '../../constants';
...
`
const IronNoOfLoads = ({IronSelectedLoads,isIronOn,handleLoadsSelect}) => {
  return (
    <div>
        <Section>
                <select name="loads" id="loads"
                    value={IronSelectedLoads}
                    disabled={!isIronOn}
