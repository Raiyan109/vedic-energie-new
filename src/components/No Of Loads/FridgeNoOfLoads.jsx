...
import { FridgeLoads } from '../../constants';
...
const FridgeNoOfLoads = ({FridgeSelectedLoads, isFridgeOn, handleLoadsSelect}) => {
  return (
    <div>
         <Section>
                <select name="loads" id="loads"
                    value={FridgeSelectedLoads}
                    disabled={!isFridgeOn}
...
export default FridgeNoOfLoads