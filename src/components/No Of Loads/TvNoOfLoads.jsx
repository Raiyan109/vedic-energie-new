...
`
const TvNoOfLoads = ({TvSelectedLoads, isTvOn,handleLoadsSelect}) => {
  return (
    <div>
        <Section>
                <select name="loads" id="loads"
                    value={TvSelectedLoads}
                    disabled={!isTvOn}
