    ...
    return (
        <Section>
            <div className='flex flex-col justify-center items-center py-32 px-5'>
                ...
                <p className="py-7 text-white lg:w-2/3 mx-auto leading-relaxed text-sm font-light lg:text-center md:text-left text-left">It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point
