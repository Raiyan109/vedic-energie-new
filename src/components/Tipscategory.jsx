...
export default function Tipscategory(){
    ...
    return(
        <div className="bg-sandal py-[100px]">  
         ...
         <details class="group [&_summary::-webkit-details-marker]:hidden border-[3px] bg-white border-brown my-10 mx-10">
      
      <p className="bg-indigo">
...
<summary
class="flex cursor-pointer items-center justify-between rounded-lg bg-gray-50 text-gray-900"
>
...
<details class="group [&_summary::-webkit-details-marker]:hidden border-[3px] bg-white border-brown my-10 mx-10">
    ...
    <summary
      class="flex cursor-pointer items-center justify-between gap-1.5 rounded-lg bg-gray-50 text-gray-900"
    >
