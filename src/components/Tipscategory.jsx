...
export default function Tipscategory(){
    ...
    return(
        <div className="bg-sandal ">
         ...
         <details class="group [&_summary::-webkit-details-marker]:hidden border-[3px] bg-white border-brown w-[1303px] ml-16 my-10">
      
      <p className="bg-indigo w-[1299px]">
...
<summary
class="flex cursor-pointer items-center justify-between gap-6 rounded-lg bg-gray-50 p-4 text-gray-900"
>
